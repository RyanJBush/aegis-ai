...
def _create_vulnerability(
    ...
    *,
    ...
    vuln = Vulnerability(
        ...
        description="Reflected XSS payload pattern in search parameter.",
        affected_endpoint="/search",
        evidence="X" * 300,
        example_request="GET /search?q=%3Cscript%3Ealert(1)%3C/script%3E",
        example_response='{"status":"blocked"}',
